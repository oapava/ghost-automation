...
describe('Crear un post', () => {
   ...
   it('Escenario 11: Crear y editar una página en Ghost', () => {
    ...
    it('Escenario 10: Crear y publicar una página con un video de YouTube', () => {
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 11: Crear, publicar y eliminar una página en Ghost', () => {
    ...
    it('Escenario 12: Crear una pagina y agregar un link de youtube invalido', () =>{
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 14: Crear y publicar una página con un video de YouTube en la que el título tenga más de 254 caracteres.', () => {
        ...
        it('Escenario 15: Crear una página con un título vacío y un video embebido.', () => {
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 16: Crear múltiples etiquetas con el mismo nombre.', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
        ...
        Then.validateTagWasCreatedName("Ciencia");
         ...
         it('Escenario 17: Crear una página con un título que incluye caracteres especiales como #@$%^&*.', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 18: Crear una etiqueta con un nombre largo+ 200', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
    ...
    it('Escenario 19: Crear una etiqueta con emojis y símbolos especiales', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
    ...
    it('Escenario 20: Crear una etiqueta con un nombre de exactamente 190 caracteres.', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
    ...
    it('Escenario 21: Crear una etiqueta con una descripción de exactamente 500 caracteres.', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
    ...
    it('Escenario 22: Crear una etiqueta con una descripción de exactamente 501 caracteres.', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
    ...
    it('Escenario 23: Crear una nombre de 1 caracter.', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
        ...
        it('Escenario 24: Crear y editar una página en Ghost Faker', () => {
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 25: Crear y publicar una página con un video de YouTube FAKER', () => {
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 26: Crear, publicar y eliminar una página en Ghost', () => {
        ...
        Then.validatePageWasCreatedAndDeleted();
         ...
         it('Escenario 27: Crear una página con un título que incluye caracteres especiales como #@$%^&*. Faker', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
        ...
        it('Escenario 28: Crear un tag usando faker', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
    ...
    it('Escenario 29: Crear una etiqueta nueva y verificar su creación en el módulo de tags.', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
        ...
        it('Escenario 30: Crear un tag usando faker execendiendo maximo de caracteres', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
        ...
        it('Escenario 31: Crear y publicar una página con un video de YouTube Mockaroo', () => {
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
    ...
    it('Escenario 32: Crear y publicar una página con un video de YouTube Mockaroo', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
        ...
        it('Escenario 33: Crear, publicar y eliminar una página en Ghost Mockaroo', () => {
    ...
    it('Escenario 34: Crear una etiqueta con una descripción que incluya caracteres especiales (#@$%^&*).', () => {
        // GIVEN: Visitar Tags
        Given.givenNavigateToTagsPage();
        ...
        it('Escenario 35: Crear y editar una página en Ghost para que el titulo tenga emojis', () => {
        // GIVEN: Visitar Pages
        Given.givenNavigateToPagePage();
        ...
        Then.validatePageWasEditedAndCreated();
         ...
         it('Escenario 36: Crear una página con HTML que incluya tablas.', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
        ...
        Then. seePagePublishedWithHtmlName("Pagina con tabla HTML")
         ...
         it('Escenario 37: Crear una página con HTML que incluya una lista.', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
        ...
        Then. seePagePublishedWithHtmlName("Página con lista HTML")
         ...
         it('Escenario 38: Crear una página con HTML con imagen y parrafo.', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
        ...
        Then. seePagePublishedWithHtmlName("The Rise of Sustainable Energy")
         ...
         it('Escenario 39: Crear una página con HTML  con enlace y párrafos.', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
        ...
        Then. seePagePublishedWithHtmlName("Exploring the Depths of the Ocean")
         ...
         it('Escenario 40: Crear una página con  HTML con video y formulario de contacto.', () => {
        // THEN: Visitar pagina de posts
        Given.givenNavigateToPagePage();
